...
//       const res =  axios.get(
//         `http://127.0.0.1:8000/api/service_image/${db_data?.id}/`,
//         // `https://cfmotoworld.pythonanywhere.com/api/service_image/${db_data?.id}/`,
//       ).then((res)=>{
//         if (res?.data && res.data.length > 0) {
//           const data = res.data[0];
          
//           if (data.image1) {
//             setSelectedFile1(`https://cfmotoworld.pythonanywhere.com${data.image1}`);
//           }
          
//           if (data.image2) {
//             setSelectedFile2(`https://cfmotoworld.pythonanywhere.com${data.image2}`);
//           }
          
//           if (data.image3) {
//             setSelectedFile3(`https://cfmotoworld.pythonanywhere.com${data.image3}`);
//           }
          
//           if (data.image4) {
//             setSelectedFile4(`https://cfmotoworld.pythonanywhere.com${data.image4}`);
//           }
//         }
...
//           "https://cfmotoworld.pythonanywhere.com/product-service/create/",
...
//         }
//         fetch(
//           "https://cfmotoworld.pythonanywhere.com/history/create/",
...
//     //     const res = await axios.post(
//     //       "http://127.0.0.1:8000/create_product_services/",
//     //       // "https://cfmotoworld.pythonanywhere.com/product-service/create/",
//     //       data
//     //     )
...
//       e.preventDefault();
//       const data = [];
//       console.log("Checking saveServices: Start of saveServices function");
//       console.log("Checking saveServices: isChecked", isChecked);
//       var time_sum = 0;
//       for (const index in isChecked) {
//         if (Object.hasOwnProperty.call(isChecked, index)) {
//           console.log(
//             "Checking saveServices: Loop iteration",
//             index,
//             "isChecked:",
//             isChecked[index],
//             "isYesChecked:",
...
//             time_sum += timerRef.current[index];
//             console.log(
//               "Checking saveServices: Added data for index",
//               index,
//               "Data:",
//               data
//             );
...
//       console.log("Checking saveServices: End of data loop");
//       console.log("Checking saveServices: Total time_sum", time_sum);
//       if (data.length === 0) {
//         console.log("Checking saveServices: Services is empty!");
//         alert("Services is empty!");
//         return;
//       } else {
//         try {
//           console.log("Checking saveServices: Sending POST request to create services");
...
//           if (res) {
//             console.log("Checking saveServices: Response of services", res);
//           }
//           var formdata = new FormData();
//           formdata.append(
//             "description",
...
//           console.log("Checking saveServices: Sending POST request to create history");
...
//           )
//             .then((response) => response.text())
//             .then((result) => console.log("Checking saveServices: Result of history creation", result))
//             .catch((error) => console.log("Checking saveServices: Error creating history", error));
    
//           alert("Checking saveServices: History has been created");
//           navigate("/vehicleData");
//         } catch (error) {
//           console.log("Checking saveServices: Error uploading file", error);
//         }
//       }
//       console.log("Checking saveServices: End of saveServices function");
//     };
...
//             // "https://cfmotoworld.pythonanywhere.com/service-image/",
//             data
//           )
//           if (res) {
//             setSelectedFile1("")
...
//         try {
//           const res = await axios.post(
//             "http://127.0.0.1:8000/mechanical-notes/create/",
//             // "https://cfmotoworld.pythonanywhere.com/mechanical-notes/create/",
//             post
//           )
...
//     const getSpareParts = ()=>{
//       const res =  axios.get(
//         // "http://127.0.0.1:8000/product-service/create/",
//         `http://127.0.0.1:8000/api/newspareparts/${db_data?.sku}/`,
  
//         // `https://cfmotoworld.pythonanywhere.com/api/newspareparts/${db_data?.sku}/`,
//       ).then((res)=>{
//         if(res?.data && res?.data.length>0){
...
//           `http://127.0.0.1:8000/api/maintenance-list-point/factory/${db_data?.factory_name}/`
//           // `http://127.0.0.1:8000/maintenance-lists/factory//`
//           // `https://cfmotoworld.pythonanywhere.com/getallservices/?sku_name=${db_data?.sku}&mileage=${selectedMileage}`
//         )
//         console.log("------kgkhckjfhbkjhkjjhj----", res)
//         setServices(res)
//       // }
...
//     //   const res = await axios.get(
//     //     "https://cfmotoworld.pythonanywhere.com/mileages/",
//     //   )
//     //   const options=[]
