...
function Maintainence() {
    ...
    const saveMentainence = ()=>{
      ...
      if(dataPost?.customer_description==""){
        alert("Please Customer description")
      }
      if(dataPost?.receiver_description==""){
        alert("Please provide Receiver description")
      }
      if(dataPost?.mileage==""){
      ...
      if(!dataPost?.video){
        ...
        postImgs();
        console.log("lllllllllllkkkkkkkkkkkkkkkkkkk",selectedCards)
        ...
        const res =  axios.post(
          ...
          "https://api.cfmoto.world/api/repairing/create/",
          // `https://api.cfmoto.world/api/repairing/create/`,
          data
        ).then((res)=>{
          var formdata = new FormData()
          formdata.append("description", `Repairing saved against SKU ${db_data?.sku} in ${timerRefm.current} seconds`)
    ...
    //   const res =  axios.get(
    //     // "https://api.cfmoto.world/product-service/create/",
    //     `https://api.cfmoto.world/api/check_maintenance/${db_data?.sku}/`,
    //   ).then((res)=>{
    //     setLoading(false)
    ...
    const saveServicesSingle = async (i) => {
      ...
      try {
        ...
        formdata.append(
          ...
          "owner_email",`${data?.orderer_email}`,
        ...
        fetch(
          ...
          .catch((error) => console.log("edb_rror", error))
                    ...
                    <div className="grid grid-cols-2 xl:grid-cols-4 gap-5 md:gap-y-[27px] md:gap-x-[30px]">
                      ...
                      <div>
                        ...
                        <div
                          ...
                          onClick={(e) => handleImageClick(fileInputRef5)}>
                          {!selectedFile5 && (
                            <div className="flex flex-col justify-center items-center cursor-pointer">
                              <img src={placeholder_img} alt="add-img" />
                              <div className=" text-f_18_l_28 mt-3.5">Add Photo</div>
